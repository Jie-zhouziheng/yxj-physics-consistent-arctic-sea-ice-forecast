...
def main():
    ...
    parser.add_argument("--config", type=str, default="configs/simvp_base.yaml")
    ...
    tag = f"simvp_K{out_steps}_seed{seed}"
    ...
    mid_depth = int(get(cfg, "model.mid_depth", 4))
    kt = int(get(cfg, "model.kt", 3))
    ...
    ckpt_name = f"SimVP_K{out_steps}_seed{seed}.pt"
    ...
    out_csv = res_dir / f"models_test_simvp_K{out_steps}.csv"
